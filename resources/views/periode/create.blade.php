...
<div class="row">
    <div class="col-12">
        ...
        @endif
        <div class="card">
            {!! Form::open(array('route' => ['periode.store'],'method'=>'POST','role' =>
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-6">
                        <input class="form-control" type="date" value="" name="keterangan" />
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nama" class="col-2 col-form-label">Status</label>
                    <div class="col-6">
                        {!! Form::select('status', ["Aktif","Non-Aktif"], null,['class'=>'select2 form-control']) !!}
                    </div>
                </div>
